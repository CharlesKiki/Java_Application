									...
									<div class="row" style="margin-top: 10px;">
										...
										<div class="col-md-3" style="padding-left: 0;">
											<select class="selectpicker form-control " onchange="changeSelect()" name="selectDisease" id="selectDisease">
												<option selected value="allDisease">所有条目</option>
								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											int count = DiseaseDAOFactory.getDiseaseInstance().getDiseaseCount();
											...
											ArrayList<Disease> result = DiseaseDAOFactory.getDiseaseInstance().getAllDiseasePage(start,pagelength);
													%>
