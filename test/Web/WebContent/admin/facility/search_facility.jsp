	...
	<div class="container-all">
		...
		<div class="context">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="<%=path%>/admin/search_person.jsp"
										id="people_info">个人基本信息</a></li>
									<li><a href="<%=path%>/admin/search_company.jsp"
						...
						<div id="collapseTwo" class="panel-collapse collapse in">
							<div class="panel-body">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="<%=path%>/admin/search_facility.jsp"
										id="facility_info">服务设施信息
											<div class="glyphicon glyphicon-ok fr"></div>
									</a></li>
									<li><a href="<%=path%>/admin/search_disease.jsp" id="disease_info">病种信息</a></li>
									<li><a href="<%=path%>/admin/search_drug.jsp" id="drug_info">药品信息</a></li>
									<li><a href="<%=path%>/admin/search_zhenliao.jsp" id="zhenliao_info">诊疗项目信息</a></li>
									<li><a href="<%=path%>/admin/search_canshu.jsp" id="parameter_info">待遇参数信息</a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="information col-md-10">
				<div id="facilitiy">
					<div class="menu" id="subnav_facility">
						<a href="<%=path%>/admin/search_facility.jsp"><button
								type="submit" class="btn btn-primary mybutton active">查询信息</button></a>
						<a href="<%=path%>/admin/add_facility.jsp"><button
						...
						<div class="search_facility">
							<div class="panel panel-default">
										...
										<form action="<%=path%>/searchFacility" method="get"
											...
											<div class="col-md-3" style="padding-left: 0;">
												<select class="selectpicker form-control " onchange="changeSelect()"
													...
													<option selected value="allFacility">所有条目</option>
								...
								<div class="panel-body">
										...
										<form id="del" action="<%=path%>/delFacility" method="get"
											...
											<table
												...
												<tbody>
													...
													int count = FacilityDAOFactory.getFacilityInstance().getFacilityCount();
													...
													ArrayList<Facility> result = FacilityDAOFactory.getFacilityInstance().getAllFacilityPage(start,pagelength);
													%>
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	<div class="add_facilities">
																		<div class="row"></div>
																		<div class="row"></div>
																		<form id="updtest" action="<%=path%>/updFaciliy"
																				...
																				<div class="container">
																					<div class="row">
																						...
																						<label class="col-md-3">服务设施编号：</label> <input
																							type="text" class="col-md-6" name="upd_ser_ID"
																							id="upd_ser_ID" />
																					...
																					<div class="row">
																						...
																						<label class="col-md-3">服务设施名称：</label> <input
																							type="text" class="col-md-6" name="upd_name"
																							id="upd_name" onfocus='this.value=""' />
																					</div>
																					<div class="row">
																						<div class="col-md-1"></div>
																					...
																					<div class="row">
																						...
																						<label class="col-md-3">限制使用范围：</label> <input
																							...
																							name="upd_usable_range" id="upd_usable_range" />
																					</div>
																					<div class="row">
																						<div class="col-md-1"></div>
																						<label class="col-md-3">备注：</label> <input
																							type="text" class="col-md-6" name="upd_notes"
																							id="upd_notes" />
																					</div>
																				</div>
																			</div>
													...
													<tr>
														...
														<td><input type="image"
															...
															data-toggle="modal" data-target=".<%=i%>"></td>
														<td><%=f.getSer_ID()%></td>
														<td><%=f.getName()%></td>
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	<div class="add_facilities">
																		<div class="row"></div>
																		<div class="row"></div>
																		<form id="upd<%=i%>" action="<%=path%>/updFaciliy"
																			method="post" onsubmit="return false">
																			<div class="form-group">
																				<div class="container">
																					<div class="row">
									...
									%>
										<a href="<%=path %>/admin/facility/search_facility.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/facility/search_facility.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/facility/search_facility.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/facility/search_facility.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/facility/search_facility.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/facility/search_facility.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
