				...
				<div id="person">
					<div class="menu" name="subnav_person" id="subnav_person">
						<a href="<%=path%>/admin/person/search_person.jsp"><button type="submit"
							...
							href="<%=path%>/admin/perosn/add_person.jsp"><button type="submit"
									...
									<form action="<%=path %>/searchPerson" method="get" onsubmit="return false" id="searchPerson">
										...
										<div class="col-md-3" style="padding-left: 0;">
											<select class="selectpicker form-control" id="selectPerson" name="selectPerson" onchange="changeSelect()">
												...
												<option selected value="personName">姓名</option>
											</select>
										</div>
										<div class="col-md-2" style="padding-right: 0;">
										...
										<div class="col-md-5" style="padding-left: 0;">
											<div class="input-group">
												<input type="text" class="form-control" placeholder="请点击查找"  style="margin-top:0;" name="contextPerson" id="contextPerson" value="${selectedContext }" onfocus='this.value=""'>
...
<form id="perdel" action="<%=path %>/delPerson" method="get" onsubmit="return false">
										<table
											...
											<%
												...
												int count = PersonDAOFactory.getPersonInstance().getPersonByNameCount(selectedContext);
												...
												ArrayList<Person> result=PersonDAOFactory.getPersonInstance().getPersonByNamePage(selectedContext, start, pagelength);	
												%>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="add_persons">
											<div class="row"></div>
											<div class="row"></div>
											<form id="person_upd<%=i%>" action="<%=path %>/updPersonName" method="post" onsubmit="return false">
												<div class="form-group">
													<div class="container">
														<div class="row">
											<div class="col-md-1"></div> 
									...
									%>
										<a href="<%=path %>/admin/person/search_person_name.jsp.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/person/search_person_name.jsp.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/person/search_person_name.jsp.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/person/search_person_name.jsp.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/person/search_person_name.jsp.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/person/search_person_name.jsp.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
