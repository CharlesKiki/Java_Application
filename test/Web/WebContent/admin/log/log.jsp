						...
						<div class="search_log">
							<div class="panel panel-default">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="input-group" style="padding: 0; margin-left: -50px; margin-right: 25px;">
															<input type="text" class="form-control" name="contextLog"
								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											<tbody>
												...
												int count = LogDAOFactory.getLogInstance().getAllLogCount();
												...
												ArrayList<AdminLog> result = LogDAOFactory.getLogInstance().getAllLogPage(start,pagelength);
									...
									%>
										<a href="<%=path %>/admin/log/log.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/log/log.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/log/log.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/log/log.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/log/log.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/log/log.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
