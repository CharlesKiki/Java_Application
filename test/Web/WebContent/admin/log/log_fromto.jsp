						...
						<div class="search_log">
							<div class="panel panel-default">
												...
												<div class="row">
													...
													<div class="col-md-6" style="padding: 0; margin: 0;">
														<select  class=" selectpicker form-control" onchange="changeSelect()"
															...
															<option selected value="LogTime">操作日期</option>
														</select>
								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											<tbody>
												...
												int count = LogDAOFactory.getLogInstance().getLogFromToCount(from,to);
												...
												ArrayList<AdminLog> result = LogDAOFactory.getLogInstance().getLogFromToPage(from,to,start,pagelength);
									...
									%>
										<a href="<%=path %>/admin/log/log_fromto.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/log/log_fromto.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/log/log_fromto.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/log/log_fromto.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/log/log_fromto.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/log/log_fromto.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
