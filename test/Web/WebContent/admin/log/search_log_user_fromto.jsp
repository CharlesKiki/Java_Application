						...
						<div class="search_log">
							<div class="panel panel-default">
												...
												<div class="row">
													...
													<div class="col-md-6" style="padding: 0; margin: 0;">
														<select  class=" selectpicker form-control" onchange="changeSelect()"
															...
															<option selected value="LogUser">操作员用户名</option>
															<option value="LogAction">操作类型</option>
											...
											<div class="col-md-4">
												<div class="row">
													...
													<div class="col-md-8" style="padding: 0; margin: 0;">
														<input type="date" class="form-control" id="fromtime" value="${from }" onfocus='this.value=""'
															name="fromtime" style="margin-top: 0;">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="row">
													...
													<div class="col-md-8" style="padding: 0; margin: 0;">
														<input type="date" class="form-control" id="totime" value="${to }" onfocus='this.value=""'
															name="totime" style="margin-top: 0;">
													</div>
												</div>
											</div>
										</div>
								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											<tbody>
												...
												int count = LogDAOFactory.getLogInstance().getLogByUserFromToCount(condition,from,to);
												...
												ArrayList<AdminLog> result = LogDAOFactory.getLogInstance().getLogByUserFromToPage(condition,from,to,start,pagelength);
									...
									%>
										<a href="<%=path %>/admin/log/search_log_user_fromto.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/log/search_log_user_fromto.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/log/search_log_user_fromto.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/log/search_log_user_fromto.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/log/search_log_user_fromto.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/log/search_log_user_fromto.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
