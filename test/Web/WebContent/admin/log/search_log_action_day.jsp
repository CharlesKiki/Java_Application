						...
						<div class="search_log">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											<tbody>
												...
												int count = LogDAOFactory.getLogInstance().getLogByActionDayCount(condition,time);
												...
												ArrayList<AdminLog> result = LogDAOFactory.getLogInstance().getLogByActionDayPage(condition,time,start,pagelength);
									...
									%>
										<a href="<%=path %>/admin/log/search_log_action_day.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/log/search_log_action_day.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/log/search_log_action_day.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/log/search_log_action_day.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/log/search_log_action_day.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/log/search_log_action_day.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
