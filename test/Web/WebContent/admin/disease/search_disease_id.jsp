									...
									<div class="row" style="margin-top: 10px;">
										...
										<div class="col-md-3" style="padding-left: 0;">
											<select class="selectpicker form-control " onchange="changeSelect()" name="selectDisease" id="selectDisease">
												...
												<option selected value="DiseaseId">病种编号</option>
												<option value="DiseaseName">病种名称</option>
											</select>
										</div>
										<div class="col-md-2" style="padding-right: 0;">
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-primary"
										data-dismiss="modal">保存</button>
													...
													<tr>
													<td><input type="checkbox" name="chooseDisease" value="${diseaseById.dis_ID }"></td>
													<td><input type="image" src="<%=path %>/img/icn_edit.png"
														title="Edit" data-toggle="modal"
														data-target=".bs-example-modal-lg"></td>
													<td>${diseaseById.dis_ID }</td>
													<td>${diseaseById.name }</td>
													<td>${diseaseById.flag }</td>
													<td>${diseaseById.notes }</td>
												</tr>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="add_companies">
										<div class="row"></div>
										<div class="row"></div>
										<form id="disease_upd6" action="<%=path%>/updDisease"
											...
											<div class="form-group">
												<div class="container">
													<div class="row">
														<div class="col-md-1"></div>
														<label class="col-md-3">疾病编号：</label> <input type="text" 
															class="col-md-4 notice" value="${diseaseById.dis_ID }"
															name="upd_dis_ID6" id="upd_dis_ID6"/>
														<label class="notice">编号不可修改</label>
													</div>
													<div class="row">
														<div class="col-md-1"></div>
														<label class="col-md-3">病种名称：</label> <input type="text"
															class="col-md-6"  placeholder="${diseaseById.name }" 
															value="${diseaseById.name }" onfocus='this.value=""'
															name="upd_name6" id="upd_name6"/>
														<div class="col-md-2"></div>
													</div>
													<div class="row">
														<div class="col-md-1"></div>
														<label class="col-md-3">病种报销标志：</label> <div class="col-md-2 " style="padding-left: 0;">
												<select style="margin-top: 5px;" name="upd_flag6" id="upd_flag6">
													<option value="是">是</option>
													<option value="否">否</option>
												</select>
												<script type="text/javascript">
												document.getElementById("upd_flag6").value="${diseaseById.flag }";
												</script>
											</div>
													</div>
													<div class="row">
														<div class="col-md-1"></div>
														<label class="col-md-3">备注：</label> <input type="text"
															class="col-md-6" placeholder="${diseaseById.notes }" 
															value="${diseaseById.notes }" onfocus='this.value=""'
															name="upd_notes6" id="upd_notes6"/>
														<div class="col-md-2"></div>
													</div>
												</div>
											</div>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default"
										data-dismiss="modal">关闭</button>
									<button type="button" class="btn btn-primary"
										onclick='document.getElementById("disease_upd6").submit();'>保存</button>
								</div>
							</div>
						</div>
					</div>
