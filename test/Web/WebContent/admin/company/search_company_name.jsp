									...
									<form action="<%=path%>/searchCompany" method="get"
										...
										<div class="col-md-3" style="padding-left: 0;">
											...
											id="selectCompany" name="selectCompany">
												...
												<option selected value="companyName">单位名称</option>
											</select>
										</div>
										<div class="col-md-2" style="padding-right: 0;">
								...
								<div class="panel-body">
									...
									<form id="comdel" action="<%=path%>/delCompany" method="get" onsubmit="return false">
										<table
											...
											int count = CompanyDAOFactory.getCompanyInstance().getCompanyByNameCount(selectedContext);
											...
											ArrayList<Company> result = CompanyDAOFactory.getCompanyInstance().getCompanyByNamePage(selectedContext,start,pagelength);
													%>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="add_companies">
										<div class="row"></div>
										<div class="row"></div>
										<form id="company_upd<%=i%>" action="<%=path%>/updCompanyName"
								...
								<div class="modal-footer">
									...
									%>
										<a href="<%=path %>/admin/company/search_company_name.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/company/search_company_name.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/company/search_company_name.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/company/search_company_name.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/company/search_company_name.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/company/search_company_name.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
