								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											int count = DrugDAOFactory.getDrugInstance().getDrugByNameChCount(selectedContext);
											...
											ArrayList<Drug> result = DrugDAOFactory.getDrugInstance().getDrugByNameChPage(selectedContext,start,pagelength);
													%>
