...
/**
 * Servlet implementation class updCompanyName
 */
@WebServlet("/updCompanyName")
public class updCompanyName extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updCompanyName() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("upd_con_ID4")!=null){
			...
			c.setPostcode(request.getParameter("upd_postcode4"));
			cd.updCompany(c, username);
		}
