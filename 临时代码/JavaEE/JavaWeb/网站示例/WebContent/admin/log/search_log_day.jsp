						...
						<div class="search_log">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											<tbody>
												...
												int count = LogDAOFactory.getLogInstance().getAllLogDayCount(condition);
												...
												ArrayList<AdminLog> result = LogDAOFactory.getLogInstance().getAllLogDayPage(condition,start,pagelength);
									...
									%>
										<a href="<%=path %>/admin/log/search_log_day.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/log/search_log_day.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/log/search_log_day.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/log/search_log_day.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/log/search_log_day.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/log/search_log_day.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
