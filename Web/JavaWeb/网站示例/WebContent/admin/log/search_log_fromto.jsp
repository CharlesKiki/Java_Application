			...
			<div class="information col-md-10">
				<div id="log">
					<div class="menu" id="subnav_log">
						<a href="<%=path%>/admin/admin.jsp"><button type="submit"
						...
						<div class="search_log">
							<div class="panel panel-default">
												...
												<div class="row">
													...
													<div class="col-md-6" style="padding: 0; margin: 0;">
														<select  class=" selectpicker form-control" onchange="changeSelect()"
															...
															<option selected value="allLog">所有条目</option>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="input-group"
															style="padding: 0; margin-left: -50px; margin-right: 25px;">
								...
								<div class="panel-body">
									<div class="result">
										...
										<table
											...
											<tbody>
												...
												int count = LogDAOFactory.getLogInstance().getAllLogFromToCount(from,to);
												...
												ArrayList<AdminLog> result = LogDAOFactory.getLogInstance().getAllLogFromToPage(from,to,start,pagelength);
									...
									%>
										<a href="<%=path %>/admin/log/search_log_fromto.jsp?pageNumber=<%=n%>"><%=n%></a>
										<%
											}
										}else{
											if(number==1||number==2){
												...
												%>
												<a href="<%=path %>/admin/log/search_log_fromto.jsp?pageNumber=<%=number-2%>"><%=number-2%></a>
												<a href="<%=path %>/admin/log/search_log_fromto.jsp?pageNumber=<%=number-1%>"><%=number-1%></a>
												<a href="<%=path %>/admin/log/search_log_fromto.jsp?pageNumber=<%=number%>"><%=number%></a>
												<a href="<%=path %>/admin/log/search_log_fromto.jsp?pageNumber=<%=number+1%>"><%=number+1%></a>
												<a href="<%=path %>/admin/log/search_log_fromto.jsp?pageNumber=<%=number+2%>"><%=number+2%></a>
											<%
											}
