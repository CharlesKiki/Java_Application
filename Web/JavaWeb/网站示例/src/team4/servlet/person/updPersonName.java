...
/**
 * Servlet implementation class updPersonName
 */
@WebServlet("/updPersonName")
public class updPersonName extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updPersonName() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String selectedContext=(String) session.getAttribute("selectedContext");
		System.out.println(selectedContext);
